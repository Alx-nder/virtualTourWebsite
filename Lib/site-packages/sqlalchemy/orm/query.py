...
class Query(
    ...
    def _set_propagate_attrs(self: SelfQuery, values: Mapping[str, Any]) -> SelfQuery:
    ...
    @_generative
    def _set_lazyload_from(self: SelfQuery, state: InstanceState[Any]) -> SelfQuery:
    ...
    def select_from(self: SelfQuery, *from_obj: _FromClauseArgument) -> SelfQuery:
    ...
    @_generative
    @_assertions(_no_statement_condition)
    def distinct(self: SelfQuery, *expr: _ColumnExpressionArgument[Any]) -> SelfQuery:
    ...
    @_generative
    @_assertions(_no_clauseelement_condition)
    def from_statement(self: SelfQuery, statement: ExecutableReturnsRows) -> SelfQuery:
