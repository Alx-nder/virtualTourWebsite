...
class MapperProperty(
    ...
    def __init__(self, attribute_options: Optional[_AttributeOptions] = None) -> None:
...
class PropComparator(SQLORMOperations[_T], Generic[_T], ColumnOperators):
    ...
    def any(
        ...
        **kwargs: Any,
        ...
        return self.operate(PropComparator.any_op, criterion, **kwargs)  # type: ignore
    ...
    def has(
        ...
        **kwargs: Any,
        ...
        return self.operate(PropComparator.has_op, criterion, **kwargs)  # type: ignore
