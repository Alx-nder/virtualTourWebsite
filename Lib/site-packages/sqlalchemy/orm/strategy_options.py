...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
    ...
    def lazyload(self: Self_AbstractLoad, attr: _AttrType) -> Self_AbstractLoad:
    ...
    def defaultload(self: Self_AbstractLoad, attr: _AttrType) -> Self_AbstractLoad:
    ...
    def options(self: Self_AbstractLoad, *opts: _AbstractLoad) -> Self_AbstractLoad:
...
class _WildcardLoad(_AbstractLoad):
    ...
    def options(self: SelfWildcardLoad, *opts: _AbstractLoad) -> SelfWildcardLoad:
...
class _LoadElement(
    ...
    def _prepend_path_from(self, parent: Union[Load, _LoadElement]) -> _LoadElement:
...
class _TokenStrategyLoad(_LoadElement):
    ...
    def _prepare_for_compile_state(
        ...
        return [
            ...
            for _path in cast(TokenRegistry, effective_path).generate_for_superclasses()
        ]
