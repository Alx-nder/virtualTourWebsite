...
_SelfAliasedReturnsRows = TypeVar("_SelfAliasedReturnsRows", bound="AliasedReturnsRows")
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    @_generative
    def add_cte(self: SelfHasCTE, *ctes: CTE, nest_here: bool = False) -> SelfHasCTE:
...
SelfGenerativeSelect = typing.TypeVar("SelfGenerativeSelect", bound="GenerativeSelect")
...
class Select(
    ...
    def from_statement(self, statement: ExecutableReturnsRows) -> ExecutableReturnsRows:
    ...
    @_generative
    def distinct(self: SelfSelect, *expr: _ColumnExpressionArgument[Any]) -> SelfSelect:
    ...
    @_generative
    def select_from(self: SelfSelect, *froms: _FromClauseArgument) -> SelfSelect:
...
SelfScalarSelect = typing.TypeVar("SelfScalarSelect", bound="ScalarSelect[Any]")
...
class Exists(UnaryExpression[bool]):
    ...
    def where(self: SelfExists, *clause: _ColumnExpressionArgument[bool]) -> SelfExists:
