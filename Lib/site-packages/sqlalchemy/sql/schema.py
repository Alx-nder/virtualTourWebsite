...
SelfHasConditionalDDL = TypeVar("SelfHasConditionalDDL", bound="HasConditionalDDL")
...
class Column(DialectKWArgs, SchemaItem, ColumnClause[_T]):
        ...
        **dialect_kwargs: Any,
        ...
        if self.server_onupdate is not None:
            if isinstance(self.server_onupdate, FetchedValue):
                ...
                l_args.append(DefaultClause(self.server_onupdate, for_update=True))
    ...
    def _copy(self, **kw: Any) -> Column[Any]:
        ...
        args: List[SchemaItem] = [
            c._copy(**kw) for c in self.constraints if not c._type_bound  # type: ignore
        ] + [
            c._copy(**kw) for c in self.foreign_keys if not c.constraint  # type: ignore
        ]
