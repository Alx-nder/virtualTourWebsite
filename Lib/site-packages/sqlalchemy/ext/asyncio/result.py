...
SelfAsyncScalarResult = TypeVar("SelfAsyncScalarResult", bound="AsyncScalarResult[Any]")
...
SelfAsyncMappingResult = TypeVar("SelfAsyncMappingResult", bound="AsyncMappingResult")
...
SelfAsyncTupleResult = TypeVar("SelfAsyncTupleResult", bound="AsyncTupleResult[Any]")
