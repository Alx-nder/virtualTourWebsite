...
SelfReversibleProxy = TypeVar("SelfReversibleProxy", bound="ReversibleProxy[Any]")
...
SelfStartableContext = TypeVar("SelfStartableContext", bound="StartableContext[Any]")
...
class StartableContext(Awaitable[_T_co], abc.ABC):
    ...
    @abc.abstractmethod
    async def start(self: SelfStartableContext, is_ctxmanager: bool = False) -> _T_co:
        raise NotImplementedError()
