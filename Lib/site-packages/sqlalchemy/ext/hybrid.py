...
class _HybridExprCallableType(Protocol[_T_co]):
    def __call__(self, cls: Any) -> Union[_HasClauseElement, ColumnElement[_T_co]]:
        ...
...
Selfhybrid_property = TypeVar("Selfhybrid_property", bound="hybrid_property[Any]")
...
class Comparator(interfaces.PropComparator[_T]):
    ...
    def __init__(self, expression: Union[_HasClauseElement, ColumnElement[_T]]):
